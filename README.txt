...
Provides a Credit Card Payment Gateway WooCommerece. No Coding Required. Official PayPal Partner.
== Description ==
= Introduction =
...
In the search field type "PayPal Credit Card for WooCommerce" and click Search Plugins. Once you've found our plugin you can view details about it such as the the rating and description. Most importantly, of course, you can install it by simply clicking Install Now.
...
*	Please visit the [Support Forum] (http://wordpress.org/support/plugin/paypal-credit-card-for-woocommerce) for questions, answers, support and feature requests.


== Changelog ==
= 1.0.0 =
*	Release Date - 15 May, 1015
*  	First Version
